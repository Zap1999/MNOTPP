...
import com.zapcorp.db.DBFacade;
...
public class LoginController {
    ...
    public void gotoRegister() throws IOException{
        ...
        root = (BorderPane) FXMLLoader.load(
                Paths.get("src/main/resources/com/zapcorp/start/RegisterForm.fxml").toUri().toURL());
    ...
    private void notLoggedIn() throws IOException {
        ...
        if (result.get() == onceMore)
            root = (BorderPane) FXMLLoader.load(
                    Paths.get("src/main/resources/com/zapcorp/start/LogInForm.fxml").toUri().toURL());
